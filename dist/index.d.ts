...
declare class ModalDialog extends React.Component<ParamsDialog, any> {
    ...
    body: any | undefined;
    promiseInfo: object;
    mRefDialog: React.RefObject<HTMLDivElement | null>;
    private focusable;
    formClose: HTMLFormElement | undefined;
    mRefButtonHost: React.RefObject<HTMLDivElement | null>;
    mRefHeaderHost: React.RefObject<HTMLDivElement | null>;
    mRefBodyHost: React.RefObject<HTMLDivElement | null>;
    mRefFocusDiv: React.RefObject<HTMLDivElement | null>;
    mRefAssDiv: React.RefObject<HTMLDivElement | null>;
